...
export default function OfficerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/officer/issues', label: 'Issues' },
  ];
    ...
    <div style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          <Link href="/officer" style={{ fontSize: '1.25rem', fontWeight: 700, color: 'white', textDecoration: 'none' }}>
            CIP
          </Link>
          <div style={{ fontSize: '0.75rem', opacity: 0.6, marginTop: '0.25rem' }}>Officer Panel</div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <header style={{
          ...
          <div style={{ fontSize: '1rem', fontWeight: 600 }}>Officer Review Panel</div>
